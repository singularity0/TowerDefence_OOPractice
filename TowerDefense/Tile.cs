...
namespace TowerDefense
{
    ...
    public class Tile
    {
        ...
        public void ClearTileArea(bool destroying = false) //destroying buidlings/towers (for ex. to earn some money)
        {

            if (destroying)
            {
                User.Points += Helpers.moneyRegainedPerTowerDestroyed;
            }
            this.InUse = false;
        }
    }
